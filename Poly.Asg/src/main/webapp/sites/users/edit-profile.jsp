...
<div class="col-6 mx-auto my-0">
	<div class="card mt-4">
		...
		<div class="card-body mx-5 mt-3">
			<form action="sites/EditProfile" method="post">
				...
				<div class="row">
					<div class="form-group col-12">
						<div class="input-group">
							...
							<input required name="username" type="text" value="${user.username}"
					...
					<div class="form-group col-12">
						<div class="input-group">
							...
							<input required name="fullname" value="${user.fullname}"
								...
								aria-label="Amount (to the nearest dollar)" placeholder="Họ Tên">
						</div>
						<small 
							class="form-text text-muted">Fullname can not be empty</small>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-12">
						...
						<small 
							class="form-text text-muted">Email can not be empty</small>
					</div>
				</div>
